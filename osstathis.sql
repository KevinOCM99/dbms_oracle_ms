...
Prompt Usage : osstathis 2015-08-04_12:00:00 2015-08-04_13:00:00
...
column        START_OF_DELTA for a20
 
with base_line as (
        select
                /*+ materialize */
                snp.snap_id,
                to_char(snp.end_interval_time,'yyyy-mm-dd hh24:mi:ss')     end_time,
                ost.value
        from
 	...
 	and	begin_interval_time > to_timestamp('&t1','YYYY-MM-DD_HH24:MI:SSXFF')
        and	end_interval_time <= to_timestamp('&t2','YYYY-MM-DD_HH24:MI:SSXFF')	
        /*                                                        */
