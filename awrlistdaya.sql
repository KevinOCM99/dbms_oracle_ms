...
clear break
accept hours prompt "Please input the date [2015-08-04]? "
select c.dbid                                                 as db_id
  ...
  order by inst_id
/
break on inst_id skip page on inst_startup_time skip page on BEGIN_DATE on END_DATE
select b.inst_id 					      as inst_id
     , to_char(a.startup_time,'yyyy-mm-dd hh24:mi:ss')	      as inst_startup_time        
