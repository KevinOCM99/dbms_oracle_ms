...
SELECT rownum as ID#,TO_CHAR(created, 'YYYY-MM-DD"T"HH24:MI:SS') created, plan_name, 
...
SELECT rownum as ID#,
       /*TO_CHAR(created, 'YYYY-MM-DD"T"HH24:MI:SS') created, plan_name, enabled, accepted, fixed, reproduced, adaptive, 
       origin, 
       TO_CHAR(last_executed, 'YYYY-MM-DD"T"HH24:MI:SS') last_executed, 
       TO_CHAR(last_modified, 'YYYY-MM-DD"T"HH24:MI:SS') last_modified
       --,*/
...
SELECT rownum as ID#,
       ...
       plan_name, 
       --enabled, accepted, fixed, reproduced, adaptive, origin, 
...
SELECT rownum as ID#,TO_CHAR(a.created, 'YYYY-MM-DD"T"HH24:MI:SS') created,
       --o.name plan_name,
