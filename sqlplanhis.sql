...
column begin_interval_time for a20
...
select ss.snap_id
     ...
     , round(st.buffer_gets_delta/decode(nvl(st.buffer_gets_delta,0),0,1,decode(nvl(st.executions_delta,0),0,1,st.executions_delta))) avg_lio
