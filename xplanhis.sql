...
-- Main Xplan SQL...
-- -----------------
set termout on lines 175 pages 1000
col plan_table_output format a175
...
,    xplan_data as (
	...
	where substr(x.plan_table_output,1,1) in ('|', '-') 
	or x.plan_table_output like 'Plan hash value%'
	or x.plan_table_output like 'SQL_ID%'
        )
