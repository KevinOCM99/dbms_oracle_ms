...
SET TERMOUT OFF SERVEROUT ON LONG 1000000 LONGCHUNKSIZE 1000000 LINESIZE 120 VERIFY OFF FEEDBACK OFF HEADING OFF
...
DECLARE
  ...
  t1 DATE;
  t2 DATE;
  s1 dba_hist_sqlstat%ROWTYPE;
  s2 dba_hist_sqlstat%ROWTYPE;
  w1 NUMBER;
  w2 NUMBER;
  r NUMBER;
  e NUMBER;
